defmodule Nexus.Resources.Providers.Group do
  @moduledoc """
  Group provider selector.

  Routes to the appropriate group management implementation based on OS.
  - Linux/BSD: Uses groupadd/groupmod commands
  - macOS: Uses dscl (Directory Service command line)
  """

  alias Nexus.Resources.Providers.Group.{Darwin, Linux}

  # Linux-like systems using groupadd/groupmod
  @linux_families [:debian, :rhel, :arch, :alpine, :freebsd]

  @doc """
  Returns the appropriate group provider for the given facts.
  """
